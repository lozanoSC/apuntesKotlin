...
```
El desplazamiento a través del rango es de uno en uno, es decir, en cada paso incremento el desplazamiento dentro del rango en 1. Con *step* puedo indicar otro  incremento de desplazamiento. 
```
fun main() {
