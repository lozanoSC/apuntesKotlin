...
arrayOf() es para crear y al mismo tiempo inicializar un array. Cuando se quiere especificar un parámetro de tipo array lo que simplemente queremos es declarar su tipo y lo hacemos indicando
*Array\<tipo>*
```java
